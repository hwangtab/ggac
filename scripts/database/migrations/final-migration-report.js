  ...
  try {
    ...
    for (const func of functions) {
      try {
        await supabase.rpc(func, 
          func === 'get_profile_photo_stats' ? {} : { user_id: '00000000-0000-0000-0000-000000000000' }
        );
    ...
    try {
      ...
      if (profilesBucket) {
        ...
        console.log(`   - 크기 제한: ${profilesBucket.file_size_limit ? Math.round(profilesBucket.file_size_limit / 1024 / 1024) + 'MB' : '무제한'}`);
      } else {
