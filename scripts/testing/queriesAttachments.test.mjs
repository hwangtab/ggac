...
// 임시 첨부(is_temporary) 관련 테스트는 걷어냈다 — 검증 대상인
// deleteExpiredTempAttachments·listTemporaryAttachments 자체가 사라졌기
// 때문이다. 그 개념은 도달할 수 없었다(업로드 라우트가 temp-{UUID} id를
// 400 거부하고, 운영 DB에 is_temporary 행이 0건이었다).
