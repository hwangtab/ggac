...
export const PRESS_KO: PressContent = {
  ...
  lede: [
    '2025년 12월 2일, 익스트림 메탈 잡지 Decibel의 Gene Meyer는 신흥 그라인드코어 밴드를 소개하는 「Blast Worship」 코너에 HWA를 올리며 Demo 2025를 두고 “Demo of the year in my humble opinion”이라고 썼다. 그 데모에 실렸던 네 곡 「September Theater」·「Past Self」·「Hollow Face」·「Letter to Jane Doe」가 이번 EP에 실렸다. 나머지 네 곡은 Naiite와의 스플릿에 실물로만 나왔던 것이라 음원으로는 이번이 처음이다.',
