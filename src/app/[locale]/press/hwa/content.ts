...
export const PRESS_EN: PressContent = {
  ...
  lede: [
    'Gene Meyer gave his December 2, 2025 Blast Worship column — Decibel’s showcase for emerging grindcore bands — over to HWA and wrote of the band’s Demo 2025: “Demo of the year in my humble opinion.” Four of those songs — “September Theater,” “Past Self,” “Hollow Face” and “Letter to Jane Doe” — are on this EP: the same takes, newly mixed and mastered. The other four were recorded for the first time for this release, and reach streaming for the first time — until now they had appeared only on a physical split with Naiite.',
...
export const PRESS_KO: PressContent = {
  ...
  lede: [
    '2025년 12월 2일, 익스트림 메탈 잡지 Decibel의 Gene Meyer는 신흥 그라인드코어 밴드를 소개하는 「Blast Worship」 코너에 HWA를 올리며 Demo 2025를 두고 “Demo of the year in my humble opinion”이라고 썼다. 그 데모에 실렸던 네 곡 「September Theater」·「Past Self」·「Hollow Face」·「Letter to Jane Doe」는 같은 녹음을 새로 믹싱·마스터링해 이번 EP에 실었다. 나머지 네 곡은 이번에 처음 녹음한 곡이고, Naiite와의 스플릿에 실물로만 나왔던 것이라 음원으로는 이번이 처음이다.',
