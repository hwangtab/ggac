  ...
  return (
    <div className="prose prose-lg max-w-none">
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">1. Purpose of Processing Personal Information</h2>
        <p className="text-gray-700 leading-relaxed mb-4">
          Gyeonggi Art Collective Cooperative (hereinafter "the Cooperative") processes personal information for the following purposes:
        </p>
        <ul className="list-disc pl-6 text-gray-700 space-y-2">
          ...
          <li>Fulfilling obligations under applicable laws and the Cooperative&apos;s articles of incorporation</li>
        </ul>
      </section>

      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">2. Personal Information Retention Period</h2>
        <p className="text-gray-700 leading-relaxed mb-4">
          The Cooperative processes and retains personal information within the period consented to at the time of collection or as required by applicable law.
        </p>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">3. Personal Information Items Processed</h2>
        <p className="text-gray-700 leading-relaxed mb-4">
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 leading-relaxed">
          The Cooperative processes personal information only within the scope stated in Article 1 and
          provides it to third parties only with the data subject&apos;s consent or as permitted under
          applicable personal information protection laws.
        </p>
      </section>

      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">5. Delegation of Personal Information Processing</h2>
        <p className="text-gray-700 leading-relaxed mb-4">
          The Cooperative delegates personal information processing as follows:
        </p>
        <div className="bg-gray-50 p-4 rounded-lg">
          <ul className="list-disc pl-6 text-gray-700 space-y-2">
            <li><strong>Supabase Inc.</strong>: Database management and user authentication services</li>
            <li><strong>Vercel Inc.</strong>: Website hosting and deployment services</li>
          </ul>
        </div>
      </section>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-gray-900 mb-4">7. Security Measures for Personal Information</h2>
        <p className="text-gray-700 leading-relaxed mb-4">
          The Cooperative takes the following measures to ensure the security of personal information:
        </p>
        <ul className="list-disc pl-6 text-gray-700 space-y-2">
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 leading-relaxed">
          ...
          corrections will be announced through the notice board at least 7 days before taking effect.
        </p>
      </section>
      ...
      <div className="mt-12 pt-8 border-t border-gray-200">
        <p className="text-sm text-gray-500">
          ...
          <br />For inquiries about this Privacy Policy, please contact privacy@gac.coop.
        </p>
      </div>
    </div>
  )
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  조합은 법령에 따른 개인정보 보유・이용기간 또는 정보주체로부터 개인정보를 수집시에
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  조합은 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고
                  있습니다:
                </p>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <ul className="list-disc pl-6 text-gray-700 space-y-2">
              ...
              <div className="mt-12 pt-8 border-t border-gray-200">
                <p className="text-sm text-gray-500">
                  시행일자: 2025년 5월 1일
                  <br />본 개인정보처리방침에 대한 문의사항이 있으시면 privacy@gac.coop로 연락주시기
                  바랍니다.
                </p>
              </div>
            </div>
