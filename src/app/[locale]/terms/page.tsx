    ...
    <div className="prose prose-lg max-w-none">
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 text-gray-700 space-y-2">
          ...
          <li>
            "Post" refers to information such as text, images, or videos posted by a member on the
            Service.
          </li>
        </ul>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 leading-relaxed mb-4">
          1. These Terms of Service take effect by being posted on the Service screen or notified to
          members by other means.
        </p>
        <p className="text-gray-700 leading-relaxed">
          2. The Cooperative may amend these Terms of Service within the scope permitted by
          applicable laws, and amended terms take effect by being announced or notified in the same
          manner as paragraph 1.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 leading-relaxed mb-4">
          1. Membership is established when a user agrees to these Terms, submits a membership
          application, and the Cooperative approves such application.
        </p>
        <p className="text-gray-700 leading-relaxed">
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 text-gray-700 space-y-2">
          ...
          <li>
            Infringing on the intellectual property rights of the Cooperative or third parties
          </li>
      ...
      <div className="mt-12 pt-8 border-t border-gray-200">
        <p className="text-sm text-gray-500">
          ...
          <br />
          For inquiries about these Terms, please contact contact@gac.coop.
        </p>
      </div>
    </div>
  )
              ...
              <div className="prose prose-lg max-w-none">
                <section className="mb-8">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    이용조건 및 절차, 조합과 회원간의 권리, 의무, 책임사항 기타 필요한 사항을
                    규정함을 목적으로 합니다.
                  </p>
                </section>
