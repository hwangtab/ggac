...
const AboutPage = async () => {
  ...
  return (
    <div className="pt-20">
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-primary-50 to-accent-50">
        <div className="tw-container-custom text-center">
          ...
          <p className="tw-text-body text-gray-600 max-w-3xl mx-auto">
            경기도의 모든 스튜디오와 무대, 작업실에서 고유한 빛을 발하는 예술가들이 있습니다. 우리는
            그 빛이 외로이 흔들리지 않도록, 창작의 여정이 지치지 않도록 서로의 손을 잡습니다.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24">
        <div className="tw-container-custom">
          <div className="max-w-4xl mx-auto">
            <h2 className="tw-heading-secondary text-center mb-12">설립 목적</h2>
            <div className="prose prose-lg max-w-none">
              <p className="tw-text-body leading-relaxed mb-6">
                예술가의 열정만으로 창작의 불꽃을 온전히 지키기 어려운 시대에, 우리는 창작의 고독과
                불안정한 현실의 벽 앞에 놓여있습니다. 이러한 어려움 속에서 우리는 흩어져 있던
                예술가들의 손을 맞잡고 서로의 든든한 버팀목이 되어주고자 합니다. 경기도를 기반으로
                활동하는 예술인들이 자발적으로 모여 설립한 생산자 협동조합, '경기아트콜렉티브
                협동조합'은 바로 그 희망의 첫걸음입니다.
              </p>
              <p className="tw-text-body leading-relaxed mb-6">
                우리 조합은 자주적·자립적·자치적인 협동조합 활동을 통해 경기도 소재 예술가들을
                지원하고, 예술 창작 활동의 지속가능성을 도모하며, 지역사회 문화예술 생태계 활성화에
                기여하는 것을 목적으로 합니다. 이를 위해 조합원들의 권익 증진을 위한 교육·훈련 및
                정보 제공 활동을 적극적으로 수행하며 예술인의 든든한 동반자가 되겠습니다.
              </p>
              <p className="tw-text-body leading-relaxed mb-6">
                또한, 음원 및 음반 제작·유통, 공연 기획·운영, 문화예술 교육 등 다양한 사업을
                추진하여 조합원들의 창작물이 정당한 가치를 인정받고 대중과 만날 수 있는 길을 열
                것입니다. 이는 조합원의 경제적 자립을 도와 예술 활동이 삶의 위협이 아닌 원동력이
                되게 하는 지속가능한 예술 활동의 기반이 될 것입니다.
              </p>
              <p className="tw-text-body leading-relaxed mb-6">
                우리의 활동 무대는 경기도 전역입니다. 지역 주민 및 학생들을 위한 문화예술 교육사업을
                진행하고, 다른 협동조합 및 지역 기관과의 긴밀한 협력을 통해 예술이 모두의 일상에
                자연스럽게 스며드는 문화를 만들고자 합니다. 창작자, 기획자, 후원 조합원 등 조합의
                뜻에 동의하는 모든 이들이 함께 어우러져 서로에게 영감을 주고 새로운 도전을 응원하는
                문화 공동체를 지향합니다.
              </p>
              <p className="tw-text-body leading-relaxed mb-6">
                경기아트콜렉티브 협동조합은 예술가 개개인의 꿈이 모여 더 큰 세상을 만드는
                광장입니다. 예술가의 권리가 존중받고, 창작의 기쁨이 넘치며, 그 결실을 지역사회와
                함께 나누는 미래를 향한 여정에 여러분의 따뜻한 관심과 동참을 기다립니다.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="tw-container-custom">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="tw-heading-secondary mb-4">이사장 메시지</h2>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <br />
              <blockquote className="tw-text-body italic leading-relaxed">
                "이곳에서는 당신의 성공뿐만 아니라 실패와 고민까지도 소중한 자산이 됩니다. 주저하지
                말고 당신의 목소리를 들려주세요. 우리는 언제나 귀 기울일 준비가 되어있습니다."
              </blockquote>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 md:py-24">
        <div className="tw-container-custom">
          <h2 className="tw-heading-secondary text-center mb-12">시간의 흔적</h2>
