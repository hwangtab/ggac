        ...
        <div className="max-w-4xl mx-auto">
          ...
          {error && (
            <div className="bg-red-50 border border-red-200 rounded-lg p-6 mb-6">
              ...
              <button onClick={() => fetchActivities()} className="mt-4 tw-btn-secondary text-sm">
                다시 시도
              </button>
            </div>
          )}
            ...
            {loading ? (
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-12 text-center">
                ...
                <div className="flex justify-center gap-3">
                  <Link href="/board/write" className="tw-btn-primary">
                    게시글 작성하기
                  </Link>
                  <Link href="/board" className="tw-btn-secondary">
                    게시판 둘러보기
                  </Link>
                </div>
              </div>
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-3 text-sm text-gray-500">
                            ...
                            {activity.metadata?.category && (
                              <span
                                className={`px-2 py-1 rounded-full text-xs font-medium ${getCategoryBadgeColor(activity.metadata.category)}`}
                              >
                                {activity.metadata.category}
                              </span>
                            )}
