...
export default function MypagePage() {
  return (
    <PermissionCheck
      ...
      fallback={
        <MypageLayout title="마이페이지" description="조합원 승인 상태를 확인해주세요.">
          <div className="text-center py-12">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">승인 대기 중</h2>
    ...
    >
      <MypageLayout title="마이페이지" description="개인 정보와 아티스트 프로필을 관리하세요.">
        ...
        <div className="mt-8 bg-gradient-to-r from-primary-50 to-accent-50 rounded-lg p-6">
          <h3 className="text-lg font-semibold text-gray-900 mb-2">💡 도움말</h3>
          <div className="text-sm text-gray-600 space-y-2">
            <p>
              • <strong>개인 프로필</strong>: 기본 정보, 조합비, 계좌 정보를 수정할 수 있습니다.
            </p>
            <p>
              • <strong>아티스트 프로필</strong>: 아티스트 권한이 있는 경우 공개 프로필을 관리할 수
              있습니다.
            </p>
