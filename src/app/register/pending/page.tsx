  ...
  const checkApprovalStatus = async () => {
    ...
    try {
      ...
      if (!user.email_confirmed_at) {
        alert('먼저 이메일 인증을 완료해주세요. 가입 시 등록한 이메일함을 확인하고 인증 링크를 클릭해주세요.');
        return;
      }
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 pt-24 md:pt-28 pb-12 px-4 sm:px-6 lg:px-8 flex items-center justify-center">
      <div className="max-w-lg w-full space-y-8">
            ...
            <div className="flex items-start">
              <div className="flex-shrink-0">
                <svg className="h-5 w-5 text-blue-400" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M9 3a1 1 0 012 0v5.5a.5.5 0 001 0V4a1 1 0 112 0v4.5a.5.5 0 001 0V6a1 1 0 112 0v6a6 6 0 01-6 6H9a6 6 0 01-6-6V9a1 1 0 012 0v3a.5.5 0 001 0V9a1 1 0 012 0v.5a.5.5 0 001 0V3z" clipRule="evenodd" />
                </svg>
              </div>
              <div className="ml-3 text-blue-700">
                ...
                <div className="mt-2 text-sm space-y-2">
                  ...
                  <div className="flex items-center">
                    <span className={emailVerified ? "text-green-500 font-bold" : "text-amber-500 font-bold"}>
                      {emailVerified ? "✅" : "⏳"}
                    </span>
                    <span className="ml-2">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3 text-red-700">
                  ...
                  <div className="mt-2 text-sm space-y-1">
                    <p><strong>• 관리자 승인을 받으려면 먼저 이메일 인증을 완료해야 합니다</strong></p>
                    <p>• 등록한 이메일: <span className="font-mono text-xs bg-red-100 px-1 rounded">{userEmail}</span></p>
                    <p>• 가입 시 발송된 <strong>"이메일 인증 링크"</strong>를 클릭해주세요</p>
                    <p>• 이메일이 오지 않았다면 <strong>스팸함</strong>을 확인해주세요</p>
            ...
            <div className="p-4 rounded-md bg-green-50 border border-green-200">
              <div className="flex items-start">
                ...
                <div className="ml-3 text-green-700">
                  ...
                  <div className="mt-2 text-sm space-y-1">
                    <p><strong>• 이메일 인증이 완료되었습니다</strong></p>
        ...
        <div className="flex flex-col space-y-3">
          ...
          >
            {checkingStatus ? '확인 중...' : emailVerified === false ? '이메일 인증 상태 확인' : '관리자 승인 상태 확인'}
          </button>
