    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 pt-24 md:pt-28 pb-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-lg mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="tw-heading-secondary mb-4">가입 신청 거절</h1>
          <p className="tw-text-body text-gray-600">조합원 가입 신청이 거절되었습니다.</p>
        </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-4">
                ...
                <div className="text-gray-700 space-y-2">
                  <p>
                    제출하신 정보가 조합원 가입 기준에 부합하지 않거나, 추가 정보가 필요할 수
                    있습니다.
                  </p>
