 ...
 */
export const getOptimizedParticleCount = (baseCount: number, browserInfo: BrowserInfo): number => {
 ...
 */
export const getOptimizedImageSrc = (originalSrc: string, browserInfo: BrowserInfo): string => {
