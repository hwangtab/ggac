...
const koreanToEnglishMap: Record<string, string> = {
  ...
  // 완성형 한글 (일반적인 단어들)
  '알': 'al', '수': 'su', '없': 'eobs', '는': 'neun', '느': 'neu', '낌': 'kkim',
  '커': 'keo', '버': 'beo', '픽': 'pik', '셀': 'sel', '이': 'i', '미': 'mi',
  '지': 'ji', '테': 'te', '스': 'seu', '트': 'teu', '파': 'pa', '일': 'il',
  '업': 'eob', '로': 'ro', '드': 'deu', '다': 'da', '운': 'un',
  '마': 'ma', '크': 'keu'
};
  ...
  for (const char of text) {
    ...
    if (char >= '가' && char <= '힣') {
      ...
      if (koreanToEnglishMap[char]) {
        ...
        const choArr = ['g','gg','n','d','dd','r','m','b','bb','s','ss','','j','jj','ch','k','t','p','h'];
        const jungArr = ['a','ae','ya','yae','eo','e','yeo','ye','o','wa','wae','oe','yo','u','wo','we','wi','yu','eu','ui','i'];
        const jongArr = ['','g','gg','gs','n','nj','nh','d','r','rg','rm','rb','rs','rt','rp','rh','m','b','bs','s','ss','ng','j','ch','k','t','p','h'];
