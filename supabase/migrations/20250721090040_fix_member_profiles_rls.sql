-- 회원 관리 RLS 순환 참조 문제 완전 해결
-- 기존의 충돌하는 RLS 정책들을 모두 정리하고 안전한 새 정책 생성
...
-- ========================================
-- 3. 순환 참조 없는 관리자 확인 함수 생성
-- ========================================

-- SECURITY DEFINER 함수로 RLS 우회하여 관리자 확인
...
-- authenticated 역할이 함수를 실행할 수 있도록 권한 부여
GRANT EXECUTE ON FUNCTION public.is_admin_user(UUID) TO authenticated;
